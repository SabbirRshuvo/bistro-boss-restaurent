...
const ShopBanner = () => {
  return (
    <div className="relative w-full h-[500px]  justify-center items-center flex text-center overflow-hidden text-white">
      <img
        src={banner2}
      ...
      <div className="relative w-4/5 h-1/3 bg-black/40 items-center justify-center text-center flex flex-col ">
        ...
        <p className="text-md uppercase">would you like to tr y a dish?</p>
      </div>
    </div>
  );
};
